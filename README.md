...
жорстко зашитому в `DutyScheduleGenerator` єдиному 2-денному патерну.
**Поки що лише сам редактор** (створення/редагування/видалення шаблонів);
застосування шаблону до реальної генерації графіка (заміна вбудованого
алгоритму, мапінг "слот шаблону → адміністратор", перехід між шаблонами
при зміні кількості чергових) — свідомо окрема задача, тут не чіпається.
