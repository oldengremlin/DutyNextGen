...
Дані (`data/exchanges/`, `DUTY_EXCHANGES_DIR` — той самий підхід, що й у
`data/templates/`) і бізнес-логіка (`DutyExchangeService`: валідація
обміну, застосування до графіка, автоматичне анулювання застарілих
пропозицій) уже готові. Веб-інтерфейс — окремим наступним комітом.
