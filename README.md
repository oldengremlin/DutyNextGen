...
`data/duty/` містить місячні файли графіка, імпортовані з CVS-репозиторію
застарілого проєкту (216 файлів, 638 ревізій, 2008–2026), кожна ревізія —
окремий git-коміт з оригінальною датою та автором. Оригінальний CVS-репозиторій
