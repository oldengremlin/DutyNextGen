...
# Пропозиції обміну чергуваннями — той самий підхід, що й templates-dir
# вище: підкаталог уже змонтованого /data, окремого тому не треба.
ENV DUTY_EXCHANGES_DIR=/data/exchanges
