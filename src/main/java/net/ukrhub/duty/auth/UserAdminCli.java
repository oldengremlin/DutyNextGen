...
/**
 * Командний режим застосунку для створення/зміни пароля користувача веб-
 * автентифікації, без підняття веб-сервера й Spring-контексту (див.
 * {@code DutyNextGenApplication.main}). Первинна ініціалізація —
...
public final class UserAdminCli {
    ...
    public static void addUser(String[] args) {
        ...
        try {
            ...
            UserStore.writeUser(usersFile, username, hash);
            System.out.println("Користувача '" + username + "' збережено в " + usersFile.toAbsolutePath());
        } finally {
